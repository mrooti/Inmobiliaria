    ...
    <div class="row slide" id="slide">
        <div class="master-slider ms-skin-default" id="masterslider"> 
          ...
          <div class="ms-slide slide-1" data-delay="9"> <img src="js/masterslider/blank.html" data-src="<?php echo $source[1]['img']; ?>" alt=""/> 
            ...
            <div class="ms-layer col-md-3"
              style="right: 120px;bottom: 60px;height: 300px; background: rgba(242, 89, 0, 0.5);"
              data-type="text"
              data-delay="300"
            ...
            <h3 class="ms-layer txt-white col-md-3 text-center"
            style="right: 120px;top: 220px;padding: 0 15px;box-sizing: border-box;text-shadow: 1px 1px 2px #FFDC00;"
            data-type="text"
            data-delay="500"
            data-ease="easeOutExpo"
            data-duration="1230"
            ...
            <p class="ms-layer col-md-3 text-center txt-gray"
            style="right: 120px;top: 320px;padding: 0 15px;box-sizing: border-box;"
            data-type="text"
            data-delay="600"
            data-ease="easeOutExpo"
            data-duration="1230"
            ...
            style="right: 250px; top: 410px; padding: 6px 12px;"
            data-type="text"
            data-delay="1000"
            data-ease="easeOutExpo"
            data-duration="1200"
