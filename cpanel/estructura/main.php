...
<div class="logo-icon text-center">
	<a href="blank_page.php"><i class="lnr lnr-home"></i> </a>
</div>
			...
			<li class="menu-list">
				<a href="#"><i class="lnr lnr-cog"></i>
					...
					<ul class="sub-menu-list">
						<li><a href="propiedad.php">Listar Propiedades</a> </li>
						<li><a href="atributos.php">Lista de Atributos</a></li>
						<li><a href="tipo_propiedad.php">Lista de Tipos de Propiedad</a></li>
					</ul>
			</li>
